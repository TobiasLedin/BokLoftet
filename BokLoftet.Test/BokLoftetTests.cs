...
{
    public class BokLoftetTests : IDisposable
    {
        ...
        {
            //var category = _context.Categories.FirstOrDefault(x => x.Name == "Deckare");
        ...
        private void SeedData()
        {
            ...
            books.Add(new Book
            {
                ...
                Category = _context.Categories.First(x => x.Name == "Barnböcker"),
            ...
            {
                Author = "Lee Child",
                Category = _context.Categories.First(x => x.Name == "Thriller"),
                Title = "Jack Reacher",
